(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('events'), require('util'), require('buffer'), require('string_decoder')) :
	typeof define === 'function' && define.amd ? define(['exports', 'events', 'util', 'buffer', 'string_decoder'], factory) :
	(factory((global.stream = {}),global.events,global.util,global.buffer,global.string_decoder));
}(this, (function (exports,EE,util,buffer,string_decoder) { 'use strict';

var EE__default = 'default' in EE ? EE['default'] : EE;
...
util.inherits(Readable$1, EE__default);
...
Readable$1.prototype.on = function (ev, fn) {
  var res = EE__default.prototype.on.call(this, ev, fn);
...
util.inherits(Writable$1, EE.EventEmitter);
...
util.inherits(Duplex$1, Readable$1);
...
util.inherits(PassThrough$1, Transform$1);
...
util.inherits(Stream, EE__default);
...
Stream.prototype.pipe = function(dest, options) {
  ...
  function onerror(er) {
    cleanup();
    if (EE__default.listenerCount(this, 'error') === 0) {
...
exports.Duplex = Duplex$1;
exports.Transform = Transform$1;
exports.PassThrough = PassThrough$1;
